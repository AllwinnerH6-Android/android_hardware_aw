...
{
/*
 * Use macro to replace ro.sys.widevine_oemcrypto_level
 */
#ifdef PLATFORM_SUPPORT_SECURE_OS
	aw_mem_info.secure_level = PLATFORM_SUPPORT_SECURE_OS;
#else
	aw_mem_info.secure_level = 3;
#endif
}

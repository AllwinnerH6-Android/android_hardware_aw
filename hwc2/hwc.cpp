...
/*copy from out/soong/.intermediates/hardware/interfaces/graphics/common/1.0/
android.hardware.graphics.common@1.0_genc++_headers/gen/android/hardware/graphics/
common/1.0/types.h*/
/**
...
int hwc_set_primary(int hwid,bool wait)
{
	...
	int loop = 2;
loop:
	if (loop-- && primarydisp->displayId != hwid) {
		primarymutex->lock();
